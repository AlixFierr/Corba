...
public class frmCargo extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(), "Registro de Cargo", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Agency FB", 1, 14))); // NOI18N
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        String descrip = txtCargo.getText();

        if (accion.equals("guardar")) {
            cargo.insertarCargo(descrip);
            mostrar();
            inhabilitar();
        } else if (accion.equals("editar")) {
            int idcargo = Integer.parseInt(txtIdCargo.getText());
            cargo.actualizarCargo(idcargo, descrip);
            mostrar();
            inhabilitar();
        }
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        int seleccion = Integer.parseInt(txtIdCargo.getText());
        cargo.consultarCargo(seleccion);
        txtBuscar.setText("");
